...
function MenuState:enter()
    ...
    lockIcon = love.graphics.newImage("assets/images/menus/lock.png")

    userUI = {
        userIcon = love.graphics.newImage("assets/images/menus/userIcon.png"),
        error = love.graphics.newImage("assets/images/menus/errorIcon.png"),
        sucess = love.graphics.newImage("assets/images/menus/sucessIcon.png"),
        sizeMulti = 0,
        textAlpha = 0,
        hovered = false,
        uiActive = false,
...
function MenuState:draw()
    menuCam:attach()
        ...
        for i = 1, #menuContent, 1 do
            if not menuContent[i].lock.icon then
                menuContent[i].lock.icon = lockIcon
            end
